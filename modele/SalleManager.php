...
class SalleManager extends Manager
{
    ...
    public function getList()
    {
        ...
        {
            $salles[$donnees['id']] = new Salle($donnees['id'], $donnees['nSalle'], $donnees['nomSalle'], $donnees['nbPoste'], $donnees['indIP'], $donnees['disabled'], $donnees['area_id'], $donnees['room_name'], $donnees['sort_key'], $donnees['description'], $donnees['capacity']);
        }
        return $salles;
    }
